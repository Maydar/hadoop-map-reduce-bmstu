...
public class ThirdTableMapper extends Mapper<LongWritable, BytesRefArrayWritable, NullWritable, BytesRefArrayWritable> {

    private int numCols = 3;

    private BytesRefArrayWritable bytes;
    List<String> fields = new ArrayList<>();
    List<String> allFields = Arrays.asList("key", "revenue", "orderdate");
    List<String> selectFields = Arrays.asList("year", "revenue");
    ...
    protected void map(LongWritable key, BytesRefArrayWritable value, Context context) throws IOException, InterruptedException {
        ...
        tbl.setProperty("columns", "key,revenue,orderdate");
        ...
        try {
            ...
            for (String selectField: selectFields) {
                ...
                if (selectField.equals("revenue") && targetField.equals("432432") ) {
                    firstClause = true;
